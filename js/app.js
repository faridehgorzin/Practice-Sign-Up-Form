document.querySelector(".banner-btn").addEventListener("click", () => {
  ...
  document.querySelector(".container").style.background = "#cc683a";
...
document.querySelector(".x-btn").addEventListener("click", () => {
  ...
  document.querySelector(".container").style.cssText="background:linear-gradient(rgba(0, 0, 0, .8), rgba(0, 0, 0, .7)), url('/images/bg1.jpeg') no-repeat center;background-size:cover; ";
